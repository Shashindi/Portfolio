...
const SocialLinks: React.FC<SocialLinksProps> = ({
  ...
  return <div className={`flex items-center space-x-4 ${className}`}>
      ...
      <a href="ttps://github.com/Shashindi?tab=repositories" target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors" aria-label="GitHub">
